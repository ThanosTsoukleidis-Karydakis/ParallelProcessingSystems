                          ...
                          double *devdelta)
{
	...
	//extern __shared__ int partial_deltas[];
	//partial_deltas[threadIdx.x]=0;
						...
						int blockSize)
{
   ...
   // const unsigned int clusterBlockSharedDataSize = sizeof(int)*numThreadsPerClusterBlock; // added partial_deltas into shared mem
    ...
    do {
        ...
        checkCuda(cudaMemcpy(membership,deciveMembership,numObjs*sizeof(int),cudaMemcpyDeviceToHost)); */
