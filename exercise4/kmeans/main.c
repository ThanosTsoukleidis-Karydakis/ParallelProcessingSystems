...
int main(int argc, char **argv)
{
   ...
   // printf("I am rank %d and I have %ld objects\n",rank,rank_numObjs);
...
*/        
   ...
   // printf("Rank %d finished kmeans call\n",rank);
   ...
   // printf("I m rank %d and I have rank_numObjs = %ld\n",rank,rank_numObjs);
    MPI_Gather(&rank_numObjs, 1, MPI_INT, recvcounts, 1, MPI_INT, 0,  MPI_COMM_WORLD);
    ...
    if (rank == 0) {
         ...
         */
//	MPI_Gather(&rank_numObjs, 1, MPI_INT, recvcounts, size, MPI_INT, 0,  MPI_COMM_WORLD);
  //      printf("Gathered : Rank 0\n");
...
//	printf("displs: %d, %d\n", displs[0], displs[1]);
  ...
  //   printf("Eimai to rank %d kai perifana dilono oti elava/esteila to broadcast minima",rank);
    /*
   ...
   // printf("Eimai to rank %d kai perifana dilono oti to gatherVVVVV teliose me megali epitixia",rank);
